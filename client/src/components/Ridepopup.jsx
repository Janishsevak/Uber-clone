      ...
      <div className="flex items-center justify-between mt-5 p-3 rounded-lg bg-yellow-400 ">
        <div className="flex items-center gap-3 text-xl font-medium ">
          <img
            ...
            alt=""
          />
          <h2>{props.ride?.user?.fullname?.firstname ?? "Unknown"} {props.ride?.user?.fullname?.lastname ?? "User"}</h2>
        </div>
      ...
      <div className="flex gap-2 justify-between items-center flex-col">
        ...
        <div className="flex w-full mt-5 items-center justify-between">
          <button
            ...
            className=" mt-5 bg-green-600 font-semibold text-white p-2 px-10 rounded-lg"
          >
            Accept
          </button>
          <button
            ...
            className=" mt-5 bg-gray-300 text-gray-700 font-semibold p-2 px-10 rounded-lg"
          >
            Ignore
          </button>
        </div>
