  ...
  return (
    <div>
          ...
          <div className="flex gap-2 justify-between items-center flex-col">
            ...
            <button
              onClick={endride}
              className="w-full mt-5 flex justify-center bg-green-600 font-semibold text-white p-2 rounded-lg" > Finish Ride </button>
          </div>
        </div>
  )
}
